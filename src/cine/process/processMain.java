...
public class processMain {
    ...
    public static void processIni(int[][]revenue, int[][][]cinema,int[]losses,String[]movies, String[] users){
    ...
    public static void proccessData(String[] movies, int[][][] cinema, int[][] revenue, int[] losses, String router,String[]users) throws IOException {
        Process.dataEntry(movies);
        Process.quantProcess(users,cinema, movies);
